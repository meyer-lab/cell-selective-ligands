...
def optimizeDesign(ax, targetPop, vrange=(0, 5)):
    ...
    strats = [r"$X_0$", "Affinity", "Mixture+Affinity", "Valency+Affinity", "All"]
...
bndsDict = {
    r"$X_0$": (cBnd, (np.log(1e-12), np.log(1.01e-12)), (1, 1.01), (0.99, 1.00), (np.log(1e6), np.log(1.01e6)), (np.log(1e6), np.log(1.01e6)), (np.log(1e6), np.log(1.01e6)), (np.log(1e6), np.log(1.01e6))),
