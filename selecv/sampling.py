...
cellPopulations = {
    ...
    r"$R_1^{med}R_2^{lo}$": [4, 2, 0.5, 0.25, 0],
    r"$R_1^{hi}R_2^{lo}$": [6, 2, 0.5, 0.25, 0],
    r"$R_1^{lo}R_2^{hi}$": [2, 6, 0.25, 0.5, 0],
    r"$R_1^{med}R_2^{hi}$": [4.0, 5.9, 0.75, 0.25, 45],
    r"$R_1^{hi}R_2^{med}$": [5.9, 4.0, 0.75, 0.25, 45],
    r"$R_1^{hi}R_2^{hi}$": [6, 6, 0.75, 0.25, 45],
    r"$R_1^{med}R_2^{med}$": [4.1, 4.1, 0.25, 1, 45],
}
